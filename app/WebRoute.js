...
let ys = pfc.packlib[0].cdm.usefulFunc 
//pfc.packlib[0].cdm[0].usefulFunc //pfc.utilib.usefulFunc || pfc.func.usefulFunc
...
let content = {//// changeable-content
    ...
    routingIdea1 : function(express, useModel){
        ...
        .post("/testerPost", cors(vvart.corsOptions), Models.Dbmc_test.data )
